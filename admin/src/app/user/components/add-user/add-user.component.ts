...
export class AddUserComponent implements OnInit {
  ...
  _createForm(user: any) {
    ...
    this.otherDetailsForm = this.fb.group({
      ...
      language: [
        (user && user.userPreference && user.userPreference.language) || '',
  ...
  get whatsappNumber() {
    return this.addUserForm.get('whatsappNumber');
  }
  get mobile() {
  ...
  get fullAddress() {
    return this.addressForm.get('fullAddress');
  }
  get language() {
    return this.otherDetailsForm.get('language');
  }
  get roleids() {
    return this.otherDetailsForm.get('roleids');
  }

  _getAllRoles() {
    this._service.getAllRoles().subscribe((res: RoleApi) => (this.allRoles = res.items));
  }
  ...
  onUserAdd(personalInfoform: any, userPreference: any, addressForm: any, stepper: any) {
    ...
    this.isLoading = true;
    this._service
      .create({ ...personalInfoform, userPreference, address: addressForm, roles })
